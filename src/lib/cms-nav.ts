...
export const DEFAULT_HEADER: SeedItem[] = [
  { label: "Inicio", href: "/", icon: "Home" },
  {
    ...
    children: [
      ...
      { label: "Ciencias básicas", href: "/programas/ciencias-basicas", icon: "FlaskConical", description: "Fundamentos preclínicos" },
      { label: "Ciencias clínicas", href: "/programas/ciencias-clinicas", icon: "Stethoscope", description: "Semiología y clínica médica" },
      { label: "Internado médico", href: "/programas/internado", icon: "ClipboardList", description: "Rotaciones y hospitalización" },
      { label: "ENAM", href: "/programas/enam", icon: "Trophy", description: "Preparación intensiva" },
      { label: "Residentado médico", href: "/programas/residentado", icon: "Award", description: "Especialidades y subespecialidades" },
    ],
  },
  {
    label: "Recursos",
